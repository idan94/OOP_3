...
public class DogTest {
    ...
    public void setUp() throws Exception {
        goodStory = "Given a Dog of age 6\n"
                ...
                + "When the dog is not taken out for a walk, the number of hours is 100\n"
                + "When the dog is not taken out for a walk, the number of hours is 100\n"
                + "When the dog is not taken out for a walk, the number of hours is 100\n"
                + "Then the house condition is clean\n"
                + "When the dog is not taken out for a walk, the number of hours is 20\n"
    ...
    public void test1() throws Exception {
        try {
            ...
            System.out.println("getSentance: " + e.getSentance());
            System.out.println("getStoryExpected: " + e.getStoryExpected());
            System.out.println("getTestResult: " + e.getTestResult());
            System.out.println("getNumFail: " + e.getNumFail());
        }
    }
